...
/**
 * Defines the state of Session initialisation.
 *
 * @see YOSessionState
 */
@property YOSessionState sessionState;
...
/**
 * Returns the unique initialisation token of the Session.
 * @return token the token
 */
- (nonnull NSUUID*) token;
