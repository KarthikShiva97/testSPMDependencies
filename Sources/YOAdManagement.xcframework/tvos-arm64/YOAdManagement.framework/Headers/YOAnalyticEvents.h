...
/** \ingroup notif_defs
 *
 * Posted when a Yospace Session reports an error, which may or may not be permanent.
 *
 */
extern NSString* const YOSessionErrorNotification;
...
/** \ingroup notif_defs
 *
 * The error code dictionary key for the \ref YOSessionErrorNotification notification.
 */
extern NSString* const YOErrorCodeKey;
