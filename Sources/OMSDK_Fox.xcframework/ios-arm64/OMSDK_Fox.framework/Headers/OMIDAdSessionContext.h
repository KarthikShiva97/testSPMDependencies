 ...
 */
@interface OMIDFoxAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDFoxPartner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDFoxPartner *)partner
                               ...
                               resources:(NSArray<OMIDFoxVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
